...
curl --silent https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/iRules_v17.5_ClassSetup.sh --output /tmp/iRules_v17.5_ClassSetup.sh
...
# MOVED CODE BELOW TO 30-RL175.sh
