...
curl --silent https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/browserspecific.html.edge --output /tmp/browserspecific.html
curl --silent https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/edge.png --output /tmp/edge.png
