...
curl --silent https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/files/browserspecific.html.edge --output /tmp/browserspecific.html
curl --silent https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/files/edge.png --output /tmp/edge.png
